...
const menuItems = {
  admin: [
    ...
    { label: 'Pagu', route: 'kabupaten.index', icon: ['fab', 'buffer'] },
  ],
};
  ...
  <div class="min-h-screen bg-pattern flex flex-col">
    ...
    <div class="flex-1 pt-16 pb-12 sm:pt-16 sm:pb-0 relative">
      ...
      :style="{
        ...
        <svg class="animate-spin h-20 w-20 text-green-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
