...
<template>
  <div class="px-6 py-4">
    ...
    <ul class="mb-2">
      <li v-for="sub in kegiatan.sub_kegiatans" :key="sub.id"
        ...
        <div class="flex flex-col gap-3 rounded-md">
          ...
          <div class="flex flex-col sm:flex-row justify-between gap-3">
            <div class="flex-1 min-w-0">
              <div class="flex justify-between items-start gap-2">
                <button @click="toggleNotaDinas(sub.id)"
            ...
            <div v-if="showButtons" class="flex items-center gap-3 sm:gap-2">
              ...
              <Tooltip text="Edit" bgColor="bg-blue-500">
                <button @click="onEdit(sub, kegiatan)"
              ...
              <Tooltip text="Hapus" bgColor="bg-red-500">
                <button @click="onDelete(sub, kegiatan)"
          ...
          <!-- Nota Dinas List -->
          <div v-if="expandedSubKegiatans.includes(sub.id)"
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="nota in sub.nota_dinas" :key="nota.id" class=" hover:bg-gray-100">
                      ...
                      <td class="px-4 py-3 whitespace-nowrap text-sm">
                        ...
                        <div v-if="nota.dipakai_dari_induk > 0" class="text-xs text-gray-500">
                          Digunakan: Rp {{ formatNumber(nota.dipakai_dari_induk) }}
                        </div>
                      </td>
                      ...
                      <td v-if="showButtons" class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end space-x-2">
                          <Tooltip text="Lampiran" bgColor="bg-purple-500">
                            <button @click="emit('viewAttachment', nota)"
    ...
    <div v-if="formSubKegiatan" class="bg-gray-50 p-4 rounded-lg">
      ...
      <form @submit.prevent="onSubmit(kegiatan.id)" class="space-y-3">
        <div class="grid grid-cols-1 md:grid-cols-6 gap-2">
          <div>
            <TextInput v-model="formSubKegiatan.kode_rekening" class="w-full px-3 py-2 text-sm"
              placeholder="Kode Rekening" />
            <InputError :message="formSubKegiatan.errors.kode_rekening" />
          </div>
          <div class="md:col-span-3">
            <TextInput v-model="formSubKegiatan.nama" class="w-full px-3 py-2 text-sm"
              placeholder="Uraian Sub Kegiatan" />
